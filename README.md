...
| Модель | Размер | Точность | Скорость | Примечания | Скачать |
|---|---|---|---|---|---|
| Small | 487 МБ | ★★★☆☆ | ★★★★★ | Быстрая, подходит для несложных фраз | [↓](https://blob.handy.computer/ggml-small.bin) |
| Medium | 492 МБ | ★★★★☆ | ★★★☆☆ | Хороший баланс, квантизована (q4) | [↓](https://blob.handy.computer/whisper-medium-q4_1.bin) |
| **Turbo** | 1 600 МБ | ★★★★☆ | ★★☆☆☆ | **Рекомендуется при наличии GPU** | [↓](https://blob.handy.computer/ggml-large-v3-turbo.bin) |
| Large | 1 100 МБ | ★★★★★ | ★★☆☆☆ | Максимальная точность, квантизована (q5) | [↓](https://blob.handy.computer/ggml-large-v3-q5_0.bin) |

> После скачивания поместите `.bin` файл в `%APPDATA%\com.pais.handy\models\`

### Parakeet (CPU-оптимизированный)

| Модель | Размер | Точность | Скорость | Языки | Скачать |
|---|---|---|---|---|---|
| Parakeet V2 | 473 МБ | ★★★★★ | ★★★★★ | Только английский | [↓](https://blob.handy.computer/parakeet-v2-int8.tar.gz) |
| **Parakeet V3** | 478 МБ | ★★★★☆ | ★★★★★ | 25 языков (en, ru, uk, de, fr, es, ...) | [↓](https://blob.handy.computer/parakeet-v3-int8.tar.gz) |

> После скачивания распакуйте `.tar.gz` архив в `%APPDATA%\com.pais.handy\models\`
